...
export default function Chat({ goodsId }: { goodsId: number }) {
  ...
  return (
    <div className="relative h-screen bg-white">
      ...
      {/* 입력창*/}
      <div className="fixed bottom-0 left-0 w-full bg-white px-4 py-3 flex items-center gap-2 border-t border-gray-200">
        <input
          value={input}
          onChange={(e) => setInput(e.target.value)}
          className="flex-1 rounded-[10px] px-4 py-2 text-sm focus:outline-none focus:ring focus:ring-blue-200 bg-[#F2F2F2]"
          placeholder="메세지 보내기"
